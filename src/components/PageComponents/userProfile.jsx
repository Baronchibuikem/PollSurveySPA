...
import {
  get_single_poll,
  post_currentuser_vote,
} from "../../store/actions/poll_action";
import {
  post_followUser,
  post_unfollowUser,
  post_edit_userprofile,
  viewClickedUserById,
} from "../../store/actions/userAuthentication";
...
export default function UserProfile() {
  ...
  const post_edit_username = (data) => {
    ...
    dispatch(
      post_edit_userprofile({
        ...
        user_id: params.viewed_user.user.id,
      })
    );
  };
  ...
  return (
    <div className="row container mx-auto" style={{ marginTop: "50px" }}>
      <div className="col-md-3">
        <ProfileHeader />
      </div>
      <div className="col-md-6">
        {params.single_user.user.username ===
        params.viewed_user.user.username ? (
          ""
        ) : (
          <div>
            {get_user_followers()[1] === params.single_user.user.username ? (
              ...
              <button
                ...
                onClick={() =>
                  unfollow_user(
                    get_user_followers()[0],
                    params.viewed_user.user.id,
                    params.single_user.user.id
                  )
                }
              >
                Following
        ...
        <ul className="nav nav-tabs profile-tab" role="tablist">
          ...
          <li className="nav-item">
            <a className="nav-link" data-toggle="tab" href="#polls" role="tab">
              Polls
              <span className="mx-1">{params.single_user.polls.length}</span>
            </a>
          </li>
          <li className="nav-item">
            <a
            ...
            >
              Followers
              <span className="mx-1">
                {params.single_user.followers.map(
                  (follower) => follower.total_followers_no
                )}
              </span>{" "}
            </a>
          </li>
          <li className="nav-item">
            ...
            >
              Following
              <span className="mx-1">
                {params.single_user.followed.map(
                  (followed) => followed.total_followed_no
                )}
              </span>
            </a>
          </li>
          <li className="nav-item">
            <a className="nav-link" data-toggle="tab" href="#likes" role="tab">
              Likes
              <span className="mx-1">{params.single_user.likes.length}</span>
            </a>
          </li>
        </ul>
              ...
              <div>
                <div className="row my-3">
                  ...
                  <div className="col-md-4">
                    {params.single_user.user.image !== null ? (
                      <img
                        src={params.single_user.user.image_url}
                        alt="profile_image"
                    ...
                    params.viewed_user.user.username ? (
                      <i
                        className="fa fa-pen ml-1 pollhover"
                        data-toggle="modal"
                        data-target="#modelId6"
                        data-placement="top"
                        title="Edit"
                        style={{ color: "blue" }}
                      ></i>
                ...
                <h6 className="mt-4">
                  <div className="row">
                    ...
                    <div className="col font-weight-bold d-flex">
                      {params.single_user.user.first_name}{" "}
                      {params.single_user.user.last_name}
                ...
                <div key={poll.pk}>
                  ...
                  >
                    ...
                    >
                      ...
                      <p
                        className="card-title pollhover"
                        onClick={() => get_single_page(poll.pk)}
                      >
                        {poll.poll_question}
                      </p>
                      ...
                      <div className="d-flex justify-content-between">
                        ...
                        <span className="text-success">
                          Poll expires on : {poll.poll_expiration_date}
                        </span>
                      </div>
                  ...
                  {follower.follower_user_fullname ? (
                    <div className="card text-left">
                      ...
                      <div className="card-body">
                        <h6
                          className="card-title pollhover"
                          onClick={() => get_user(follower.follower_id)}
                        >
                          {follower.follower_user_fullname} @
                          {follower.follower_username}
                        </h6>
                        <p className="card-text">
                          {follower.follower_user_bio}
                        </p>
                      </div>
                    </div>
                  ) : (
                  ...
                  {followed.following_user_fullname ? (
                    <div className="card text-left">
                      ...
                      <div className="card-body">
                        <h6
                          className="card-title pollhover"
                          onClick={() => get_user(followed.following_id)}
                        >
                          {followed.following_user_fullname} @
                          {followed.following_username}
                        </h6>
                        <p className="card-text">
                          {followed.following_user_bio}
                        </p>
                      </div>
                    </div>
                  ) : (
                    ...
                    <div className="card text-left">
                      ...
                      <div className="card-body">
                        <h6 className="card-title">
                          {like.poll_creator_firstname}{" "}
                          {like.poll_creator_lastname} @
                          {like.poll_creator_username}
                        </h6>
